		...
		<footer className="mx-[17px] lg:mx-[50px] mt-44 font-roboto">
			<section className="lg:grid-cols-4 grid gap-4">
				<div className="w-full lg:col-span-2 col-span-4 font-bold text-2xl items-center">
					...
					<p className="text-[#ffd000] text-xs mt-[16px] font-normal font-roboto">
						@ 2022 ABCD All rights reserved
					</p>
					<h4 className="font-semibold mt-[17px] text-lg font-roboto">Subscribe to our Newsletter</h4>
					<p className="font-normal font-roboto mt-4 mb-[16px] text-xs">
				...
				<div className="sm:w-[50%]">
					...
					<Link href="/About">
						<a>
							<p className="text-xs font-normal font-roboto mt-[16px] hover:text-[#ffd000]">About Us</p>
						</a>
					</Link>
					<Link href="/Contact">
						<a>
							<p className="text-xs font-normal font-roboto mt-[6px] hover:text-[#ffd000]">Contact Us</p>
						</a>
					</Link>
					<p className="text-xs font-normal font-roboto mt-[6px] hover:text-[#ffd000]">Hire Talent</p>
				</div>

				<div>
					<h3 className="font-bold text-2xl items-center font-roboto">Get in Touch</h3>
					<p className="text-xs font-normal mt-[16px] font-roboto">info@abcdevs.com</p>
