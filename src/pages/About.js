...
export default function About() {
	return (
		<div className='w-full px-12 pt-16 mx-auto'>
			<h3 className='font-semibold font-roboto text-[30px] md:text-[50px] leading-[41px] md:leading-[68px] text-theme-main'>
				About ABCD
			</h3>
			<section className='flex flex-col items-center lg:flex-row lg:justify-between'>
				<figure className='w-full lg:w-1/2 lg:order-last'>
					<Image src={AboutHero} width={747} height={559} alt='About Hero' />
				</figure>
				<div className='w-full lg:w-1/2 font-roboto font-normal text-sm md:text-lg leading-[40px] py-4'>
					<p>
						African Blockchain Centre for Developers is focused on providing a full suite of solutions to
						help organizations build on different blockchains/Layer 2 technologies by providing talent and
						quality assurance. This includes web3 product managers, web3 product designers, smart contract
						engineers/security auditors/testing, Dapp developers etc. With this complete suite of our
						workforce, we help organizations/projects hire vetted talents, outsource development, manage
						their product or get access to top-notch consultancy based on their needs in the web3 space.
					</p>
					<Link href='/FAQ'>
						<a>
			...
			{/**ABCD JOURNEY */}
			<section className='w-full flex items-center flex-col lg:justify-between lg:flex-row py-4'>
				<figure className='w-full lg:w-1/2 lg:mt-24'>
				...
				<div className='w-full lg:w-1/2'>
					...
					<p className='font-roboto font-normal text-lg leading-10 py-2'>
						...
						web3 developers in the global market. As our community opened up, for sustainable development we
						decided to build a talent management company that brings opportunities to the talent pool we
						manage.
					</p>
				</div>
			</section>
			...
			<section className=' relative grid lg:grid-flow-row lg:grid-cols-2 mx-[25px] lg:mx-[74px] gap-4 my-8 md:bg-[url("/assets/vector-about.svg")] md:bg-no-repeat md:bg-cover md:bg-center'>
				<WhyABCD
			...
			<div className='bg-[#121212] p-8 lg:w-[600px] mx-[25px] lg:mx-auto mb-24 mt-4'>
				...
				<ul className='list-decimal list-inside text-sm leading-10'>
					...
					<li>
						Collaboration and initiation of new ideas with the potential to solve problems on the continent.
					</li>
